...
<body class="bg"> 
    ...
    <a href="mlogin.jsp" style="margin-left:90%;color:white;background-color:black">Mentor Login</a>
    <%session.setAttribute("login", "1"); %>
    <%session.setAttribute("role","student"); %>
	<div class="form-box" style="top: 150px">
		<form action="<%=request.getContextPath()%>/checkusersendmail" method="post">
